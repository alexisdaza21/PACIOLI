     ...
     <div class="container">
        <div class="row">
            <div class ="panel panel-primary">
                <div class="panel-heading" ><h2 align="center" style="padding: 0;margin: 0; color:#fff;">Visitas del trabajo <?=  $trabajos->tipo ?></h2></div>
                    <div class="panel-body">        
                     <form action="index.php?c=visitas&a=createTra" method="post">        
