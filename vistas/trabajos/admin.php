    ...
    <td align="center"><?= $trabajo->Trab3->nombres;?></td>
                                ...
                                <td align="center">
                                  ...
                                  <ul class="dropdown-menu">
                                     <li><a data-toggle="modal" data-target="#modal_tarea<?= $trabajo->id_trabajos ?>" class="btn btn-primary btn-flat"  href>Agregar Tarea</a></li>
                                   ...
                                   <?php 
                                    ...
                                    <!--  <li>
                                      <a onclick="editar('<?= $trabajo->id_trabajos; ?>','<?= $trabajo->tipo ?>','<?= $_GET["id"]?>')"
...
<div class="modal fade" id="modal_tarea<?= $trabajo->id_trabajos ?>" tabindex="-1" role="dialog" aria-labelledby="basic_modal" style="display: none;">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
               agregar  tarea al trabajo 
               <br><?= $trabajo->tipo ?>
              <ul class="card-actions icons right-top">
                <a href="javascript:void(0)" data-dismiss="modal" class="text-white" aria-label="Close">
                  <i class="zmdi zmdi-close"></i>
          ...
          <div class="modal-body">        
        <form action="index.php?c=tareas&a=createuno" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="card">
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group is-empty">
                          <div class="input-group">
                            <span class="input-group-addon"><i class=""></i></span>
                             <input type="hidden" name="Tareas[id_trabajos]" value="<?= $trabajo->id_trabajos ?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-6">
                        <div class="form-group is-empty">
                          <div class="input-group">
                            ...
                            <input type="hidden" name="Tareas[id_clientes]" value="<?= $_GET['id'] ?>">
                  ...
                  <div class="card-body">
                   <div class="col-xs-6">
                        <div class="form-group is-empty">
                          ...
                          <div class="input-group">
                            <label >Tipo</label>
                            <input class="form-control " maxlength="45" type="text"  name="Trabajos[tipo]"   value="" required/>
                        </div>
                        </div>
                          <div class="col-xs-6">
