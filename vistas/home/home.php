										...
										<div class="col-lg-4">
											<div class="card type--profile">
												<header class="card-heading card-background" id="card_img_01">
													<img src="assets/img/profiles/large_02.jpg" alt="" class="img-circle ">
													<ul class="card-actions icons  right-top">
														<li class="dropdown">
															<a href="javascript:void(0)" data-toggle="dropdown">
													...
													<ul class="scrum-group">
														...
														<li class="scrum-item back-log">
															...
															<div class="scrum-body p-t-5 p-b-10">
																<img src="assets/img/profiles/01.jpg" alt="" class="img-circle" />
																<img src="assets/img/profiles/03.jpg" alt="" class="img-circle" />
																<img src="assets/img/profiles/08.jpg" alt="" class="img-circle" />
															</div>
														...
														<li class="scrum-item on-hold">
															...
															<div class="scrum-body p-t-5 p-b-10">
																<img src="assets/img/profiles/02.jpg" alt="" class="img-circle" />
																<img src="assets/img/profiles/06.jpg" alt="" class="img-circle" />
															</div>
															<div class="scrum-footer p-15">
														...
														<li class="scrum-item complete">
															...
															<div class="scrum-body p-t-5 p-b-10">
																<img src="assets/img/profiles/07.jpg" alt="" class="img-circle" />
																<img src="assets/img/profiles/05.jpg" alt="" class="img-circle" />
																<img src="assets/img/profiles/15.jpg" alt="" class="img-circle" />
															</div>
															<div class="scrum-footer p-15">
															...
															<div class="card image-over-card">
																<div class="card-image">
																	<a href="javascript:vodi(0)">
																		<img src="assets/img/gallery/full/full-11.jpg">
																	</a>
																</div>
																<div class="card-body">
															...
															<div class="card image-over-card">
																<div class="card-image">
																	<a href="javascript:void(0)">
																		<img src="assets/img/gallery/full/full-13.jpg">
																	</a>
																</div>
																<div class="card-body">
													...
													<div class="card type--scheduler ">
														...
														<div class="card-body clear-both p-0 max-h-500 scrollbar">
															<div class="week-container">
																<ul class="week top">
																	<li class="day day-names"><span>Dom</span></li>
																	<li class="day day-names"><span>Lun</span></li>
																	<li class="day day-names"><span>Mar</span></li>
																	<li class="day day-names"><span>Mie</span></li>
																	<li class="day day-names"><span>Jue</span></li>
																	<li class="day day-names"><span>Vie</span></li>
																	<li class="day day-names"><span>Sab</span></li>
																</ul>
															...
															<ul class="list-group p-0">
																<li class="list-group-item border-top p-t-20 p-b-20">
																	<span class="pull-left"><img src="assets/img/profiles/01.jpg" alt="" class="img-circle max-w-50 m-r-10"></span>
																	<div class="list-group-item-body">
																...
																<li class="list-group-item border-top p-t-20 p-b-20">
																	<span class="pull-left"><img src="assets/img/profiles/04.jpg" alt="" class="img-circle max-w-50 m-r-10"></span>
																	<div class="list-group-item-body">
																...
																<li class="list-group-item border-top p-t-20 p-b-20">
																	<span class="pull-left"><img src="assets/img/profiles/18.jpg" alt="" class="img-circle max-w-50 m-r-10"></span>
																	<div class="list-group-item-body">
